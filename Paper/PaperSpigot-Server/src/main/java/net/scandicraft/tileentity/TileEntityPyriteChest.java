...
public class TileEntityPyriteChest extends TileEntityContainer implements IInventory { // PaperSpigot - remove IUpdatePlayerListBox

    private ItemStack[] items = new ItemStack[27];
    public boolean a;
    public TileEntityPyriteChest f; // PaperSpigot - adjacentChestZNeg
    public TileEntityPyriteChest g; // PaperSpigot - adjacentChestXPos
    public TileEntityPyriteChest h; // PaperSpigot - adjacentChestXNeg
    public TileEntityPyriteChest i; // PaperSpigot - adjacentChestZPos
    ...
    private void a(TileEntityPyriteChest TileEntityPyriteChest, EnumDirection enumdirection) {
        if (TileEntityPyriteChest.x()) {
            this.a = false;
        } else if (this.a) {
            switch (SyntheticClass_1.a[enumdirection.ordinal()]) {
                case 1:
                    if (this.f != TileEntityPyriteChest) {
                        this.a = false;
                    }
                    break;

                case 2:
                    if (this.i != TileEntityPyriteChest) {
                        this.a = false;
                    }
                    break;

                case 3:
                    if (this.g != TileEntityPyriteChest) {
                        this.a = false;
                    }
                    break;

                case 4:
                    if (this.h != TileEntityPyriteChest) {
                        this.a = false;
                    }
            }
        }
    ...
    protected TileEntityPyriteChest a(EnumDirection enumdirection) {
        ...
        if (this.b(blockposition)) {
            ...
            if (tileentity instanceof TileEntityPyriteChest) {
                TileEntityPyriteChest TileEntityPyriteChest = (TileEntityPyriteChest) tileentity;

                TileEntityPyriteChest.a(this, enumdirection.opposite());
                return TileEntityPyriteChest;
            }
        }
    ...
    static class SyntheticClass_1 {
        ...
        static {
            try {
                TileEntityPyriteChest.SyntheticClass_1.a[EnumDirection.NORTH.ordinal()] = 1;
            } catch (NoSuchFieldError nosuchfielderror) {
                ;
            }

            try {
                TileEntityPyriteChest.SyntheticClass_1.a[EnumDirection.SOUTH.ordinal()] = 2;
            } catch (NoSuchFieldError nosuchfielderror1) {
                ;
            }

            try {
                TileEntityPyriteChest.SyntheticClass_1.a[EnumDirection.EAST.ordinal()] = 3;
            } catch (NoSuchFieldError nosuchfielderror2) {
                ;
            }

            try {
                TileEntityPyriteChest.SyntheticClass_1.a[EnumDirection.WEST.ordinal()] = 4;
