...
public class PyriteChest extends BlockContainer {
    ...
    public void postPlace(World world, BlockPosition blockposition, IBlockData iblockdata, EntityLiving entityliving, ItemStack itemstack) {
        ...
        if (itemstack.hasName()) {
            ...
            if (tileentity instanceof TileEntityPyriteChest) {
                ((TileEntityPyriteChest) tileentity).a(itemstack.getName());
            }
        }
    ...
    public ITileInventory f(World world, BlockPosition blockposition) {
        ...
        if (!(tileentity instanceof TileEntityPyriteChest)) {
            ...
            Object object = (TileEntityPyriteChest) tileentity;
            ...
            if (this.n(world, blockposition)) {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (block == this) {
                        ...
                        if (tileentity1 instanceof TileEntityPyriteChest) {
                            if (enumdirection != EnumDirection.WEST && enumdirection != EnumDirection.NORTH) {
                                object = new InventoryLargeChest("container.chestDouble", (ITileInventory) object, (TileEntityPyriteChest) tileentity1);
                            } else {
                                object = new InventoryLargeChest("container.chestDouble", (TileEntityPyriteChest) tileentity1, (ITileInventory) object);
                            }
                        }
                    }
                }
    ...
    public int a(IBlockAccess iblockaccess, BlockPosition blockposition, IBlockData iblockdata, EnumDirection enumdirection) {
        if (!this.isPowerSource()) {
            ...
            if (tileentity instanceof TileEntityPyriteChest) {
                i = ((TileEntityPyriteChest) tileentity).l;
            }
